...
import {
  ...
  CalendarOff, AlertTriangle, ArrowRight,
  Building2, UserCog, Settings, FileText, ClipboardList,
...
const PAGE_ITEMS: SearchResult[] = [
  ...
  { id: 'page-engine', category: '페이지', icon: Settings, title: '공휴일', subtitle: '감차 적용일 관리 (배차 설정 탭)', path: '/dashboard/settings?tab=engine' },
...
const ICON_MAP: Record<string, LucideIcon> = {
  LayoutDashboard, Calendar, Users, CalendarOff, AlertTriangle,
  Bus, Map, Building2, UserCog, Settings, FileText,
};
